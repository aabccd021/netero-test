...
pkgs.symlinkJoin {
  ...
  paths = [
    ...
    (basicScript "assert-url-equal" ./assert-url-equal.sh)
    (basicScript "assert-url-length-equal" ./assert-url-length-equal.sh)
    (basicScript "assert-url-starts-with" ./assert-url-starts-with.sh)
